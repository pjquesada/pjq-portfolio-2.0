...
export const TIMELINE = {
  ...
  scatter: { start: 0.16, end: 0.5 },
  heroTravel: { start: 0.2, end: 0.8 },
  quote: {
    start: 0.64,
    stagger: 0.05,
    duration: 0.12,
  },
  silence: { start: 0.8, end: 0.9 },
